...
export const lightColors = {
  primary: "#1976D2",      // crisp blue for primary buttons
  secondary: "#c4e1ffff",    // deep orange accent
  background: "#F9FAFB",   // off-white background
  surface: "#FFFFFF",      // cards, panels
  text: "#1F2937",         // almost black text
  textSecondary: "#6B7280",// softer gray for secondary text
  link: "#0A84FF",         // iOS-style blue link
};
...
export const midnightColors = {
  ...
  background: "#0B0B28",   // deep navy background
  surface: "#151535",      // darker navy for cards/panels
