    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <RNText style={[styles.paragraph, { color: colors.text }]}>
          Ahead Ai is a professional social media platform that empowers users to connect with industry professionals, find jobs, receive expert support, and stay updated with live news.
        </RNText>
        ...
        <RNText style={[styles.paragraph, { color: colors.text }]}>
          Ahead Ai aims to bridge the gap between professionals and opportunities, helping users grow their network and career in a single app.
        </RNText>
      </ScrollView>
    </SafeAreaView>
  );
