...
const userProfileUpdates = {};
      ...
      selectedType.fields?.forEach((field) => {
        ...
        if (entry?.fileLocation) {
          ...
          if (field.label === 'PROFILE PIC ' && entry?.fileLocation) {
    userProfileUpdates.profilePic = entry.fileLocation;
  }

  if (field.label === "COMPANY" && entry?.value) {
    userProfileUpdates.name = entry.value;
  }
